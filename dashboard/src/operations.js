...
const issueQuery=`SELECT r.id,r.account_id,a.label,${kind} AS category,r.status,r.verification,r.message,r.day,r.step,r.observed_step,r.updated_at,${stamp} AS stamp,
 ...
 UNION ALL SELECT a.id,a.id,a.label,'credentials','needs_login','not_checked','Zepp 登录凭据已失效',NULL,NULL,NULL,a.updated_at,'',0,'',0,0 FROM accounts a WHERE a.needs_login=1`;
