...
const url=option('--origin')||'https://mimotion-dashboard.113618446.workers.dev';
const origin=args.includes('--origin')?url:'https://mimotion-dashboard.113618446.workers.dev';
